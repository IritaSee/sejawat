...
@section('content')
                            ...
                            <div class="col-lg-12">
                                <div class="widget-heading">
                                    ...
                                    <a href="javascript:void(0)" class="btn btn-success btn-sm mt-3" data-toggle="modal"
                                        data-target="#import_siswa">
                                        <i data-feather="file-text"></i> Impor Excel
                                    </a>
                                    <a href="{{ url('/admin/ekspor_siswa') }}" class="btn btn-warning btn-sm mt-3"
                                        target="_blank">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="javascript:void(0)" data-toggle="modal"
                                                            data-target="#edit_siswa" data-siswa="{{ $s->nis }}"
                                                            class="btn btn-primary btn-sm edit-siswa">
                                                            <i data-feather="edit"></i>
                                                        </a>
                                                        <a href="{{ url('/admin/hapus_siswa') }}/{{ $s->nis }}"
    ...
    <!-- MODAL -->
    <!-- Modal Tambah -->
    <div class="modal fade" id="tambah_siswa" tabindex="-1" role="dialog" aria-labelledby="tambah_siswaLabel"
        aria-hidden="true">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody id="tbody-siswa">
                                <tr>
                                    ...
                                    <td><input type="text" name="nama_siswa[]" required
                                            style="border: none; background: transparent; width: 100%; height: 100%;"></td>
                                    <td>
    ...
    <!-- Modal edit -->
    <div class="modal fade" id="edit_siswa" tabindex="-1" role="dialog" aria-labelledby="edit_siswaLabel"
        aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="hidden" name="id" id="id_siswa" value="{{ old('id') }}"
                                class="form-control">
    ...
    <!-- Modal IMport -->
    <div class="modal fade" id="import_siswa" tabindex="-1" role="dialog" aria-labelledby="import_siswaLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
           ...
           `;
            ...
            $("#tbody-siswa").on("click", "tr td button", function() {
                ...
                $.ajax({
                    ...
                    url: "{{ route('ajaxsiswa') }}",
                    success: function(a) {
                        $("#id_siswa").val(a.id), $("#nama_siswa").val(a.nama_siswa), $(
                            "#gender").val(a.gender), $("#email").val(a.email), $(
                            "#kelas_id").val(a.kelas_id), $("#active").val(a.is_active)
                    }
                })
            }), $(".btn-hapus").on("click", function(a) {
                a.preventDefault();
                ...
                swal({
                    ...
                    a.value && (document.location.href = t)
                })
            }), $(".custom-file-input").on("change", function() {
                var a = $(this).val().split("\\").pop();
                $(this).next(".custom-file-label").addClass("selected").html(a)
            });
        })
    </script>
