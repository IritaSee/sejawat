                                    ...
                                    <div class="widget shadow p-3">
                                        ...
                                        @if ($tugas_siswa)
                                            ...
                                            @if ($tugas_siswa->date_send === null)
                                                <p>Tugas Belum Dikerjakan. Segera dikerjakan sebelum {{ $tugas->due_date }}
                                                </p>
                                                <a href="{{ url('/siswa/tugas/kerjakan/' . $tugas_siswa->id) }}"
                                                    class="btn btn-primary btn-kerjakan">Kerjakan</a>
                                            @else
                                                {{-- Menampilkan status dan nilai --}}
                                                <table cellpadding="5">
                                                    <tr>
                                                        <th>Status</th>
                                            ...
                                            @endif
                                        @else
                                            {{-- Ini seharusnya tidak terjadi karena controller sudah memastikan $tugas_siswa selalu ada --}}
