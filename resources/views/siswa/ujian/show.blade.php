                                            ...
                                            <div class="widget p-3 mt-3">
                                                ...
                                                <div class="widget-content mt-3">
                                                    ...
                                                    <div class="mt-2" style="font-weight: bold;">
                                                        ...
                                                        @endif
                                                        @if ($soal->benar == '1')
                                                            <span class="badge badge-success ml-1">benar</span>
                                                        @endif
                                                        @if ($soal->benar == '0')
                                                            <span class="badge badge-danger ml-1">salah</span>
                                                        @endif
                                                        @if ($soal->ragu == '1')
                                ...
                                <div class="widget-footer pl-2 py-2 mt-3"
                                    ...
                                    <div class="table-responsive" style="overflow-x: scroll;">
                                        <table class="text-nowrap">
                                            ...
                                            <tr>
                                                <th>Benar : <span
                                                        class="badge badge-success mr-1 mt-1">{{ $benar }}</span> |
                                                    Salah : <span
                                                        class="badge badge-danger mr-1 mt-1">{{ $salah }}</span> |
                                                    Tidak Dijawab : <span
                                                        class="badge btn-white mt-1">{{ $tidakDijawab }}</span> | Nilai :
                                                    <span class="badge badge-primary">{{ round($nilai) }} / 100</span>
                                                </th>
                                            </tr>
                                        </table>
                                    </div>
